...
class CredentialsControllerTest < ActionController::TestCase
  ...
  test "should create credential" do
    assert_difference('Credential.count') do
      post :create, credential: { identifier: @credential.identifier, private_key: @credential.private_key, public_key: @credential.public_key, service_id: @credential.service_id }
    end
  ...
  test "should update credential" do
    patch :update, id: @credential, credential: { identifier: @credential.identifier, private_key: @credential.private_key, public_key: @credential.public_key, service_id: @credential.service_id }
    assert_redirected_to credential_path(assigns(:credential))
  end
